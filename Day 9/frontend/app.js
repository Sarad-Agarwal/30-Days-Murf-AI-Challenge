// app.js - Frontend logic for Day 9 AI Voice Agent

const FIELD_NAME = "file"; 
const ENDPOINT = "http://localhost:8000/llm/query"; // New Day 9 backend endpoint
...
async function processAudioBlob(blob){
  try {
    ...
    // Expecting: { transcription: "...", llmResponse: "...", audioUrl: "..." }
    ...
    // Display both transcription and LLM reply
